...
#ifndef TCLAP_VALUE_ARGUENT_H
#define TCLAP_VALUE_ARGUENT_H
...
template<class T> class ValueExtractor 
{
	...
	private:
		...
		/**
		 * ethod that will attempt to parse the input stream for a value
		 * of type T.
...
void ValueArg<T>::_extractValue( const std::string& val ) 
{
	...
	if ( err == VALUE_ARG_HELPER::EXTRACT_TOO_ANY )
		throw( ArgParseException(
					"ore than one valid value parsed from string '" +
				    val + "'", toString() ) );
