...
class SwitchArg : public Arg
{
	...
	public:
		 ...
		 */
		bool combinedSwitchesatch(std::string& combined);
...
inline bool SwitchArg::combinedSwitchesatch(std::string& combinedSwitches )
{
...
inline bool SwitchArg::processArg(int *i, std::vector<std::string>& args)
{
	...
	if ( argatches( args[*i] ) || combinedSwitchesatch( args[*i] ) )
	{
		...
		if ( _alreadySet || ( !ret && combinedSwitchesatch( args[*i] ) ) )
