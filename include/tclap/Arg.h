...
#ifndef TCLAP_ARGUENT_H
#define TCLAP_ARGUENT_H
...
class Arg
{
	...
	protected:
		 ...
		 * that are meant to be used.  Use SwitchArg, ValueArg, ultiArg, 
		 * UnlabeledValueArg, or UnlabeledultiArg instead.
		 *
	...
	public:
		 ...
		 * \param args - utable list of strings. What is 
		 * passed in from main.
		 */
		...
		/**
		 * Operator ==.
		 * Equality operator. ust be virtual to handle unlabeled args.
		 ...
		 */
		virtual bool argatches( const std::string& s ) const;
		...
		virtual bool acceptsultipleValues();
...
inline bool Arg::argatches( const std::string& argFlag ) const
{
...
inline bool Arg::allowore()
{
	return false;
}

inline bool Arg::acceptsultipleValues()
{
	return _acceptsultipleValues;
}
